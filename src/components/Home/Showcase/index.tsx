...
export const Showcase = () => {
  ...
  return (
    <section id="showcase" className="px-4 py-16 space-y-6 lg:px-36">
      <h2 className="text-2xl font-bold tracking-wider text-center uppercase text-main-white">
        Showcase
      </h2>
      ...
      <div>
        {showcase.testimonials.map((testimonial) => (
          <div
            ...
            className="flex flex-col md:flex-row rounded-xl bg-main-white"
          >
            <Image
            ...
            >
              ...
              <blockquote className="text-xs italic text-gray-900 lg:text-sm">
              ...
              <div className="flex flex-col items-center justify-center my-4 space-y-2 md:justify-between md:my-0 md:flex-row">
                <div className="flex ">
                  {Array.from(Array(5)).map((key, i) => (
                    <GoStar
                      key={i}
                      className="w-5 h-5 text-yellow-300 md:w-7 md:h-7 "
                    />
                  ))}
                </div>
                <div className="text-center">
                  <h3 className="text-lg font-bold uppercase text-main-black">
                    {testimonial.author}
                  </h3>
                  <h4 className="text-xs font-bold uppercase text-main-black/80">
